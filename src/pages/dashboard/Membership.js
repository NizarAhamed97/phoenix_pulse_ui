  ...
  useEffect(() => {
    const fetchMembership = async () => {
      try {
        ...
        // Destructure the response into expirySoon and overdue
      ...
      <div className="card border-info mb-4 shadow-sm">
        ...
        <div className="card-body d-flex" style={{ height: "300px" }}>
          ...
          <div className="w-50 pe-2 border-end overflow-auto">
            ...
            {/* Column Headings for Expiry Soon */}
            ...
            {expirySoon.length > 0 ? (
              ...
              <div className="d-flex align-items-center justify-content-center" style={{ height: "100%" }}>
                <p className="text-center text-muted">No memberships expiring soon</p>
              </div>
            )}
          </div>
          ...
          <div className="w-50 ps-2 overflow-auto">
            ...
            {overdue.length > 0 ? (
              ...
              <div className="d-flex align-items-center justify-content-center" style={{ height: "100%" }}>
                <p className="text-center text-muted">No overdue memberships</p>
              </div>
            )}
          </div>
        </div>
